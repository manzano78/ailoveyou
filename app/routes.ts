...
export default [
  ...
  layout('routes/ui-layout.tsx', [
    ...
    layout('routes/private-layout.tsx', [
      ...
      route('profile-capture', 'routes/private/profile-capture/layout.tsx', [
        ...
        route(
          'get-audio/:text',
          'routes/private/profile-capture/get-audio.tsx',
        ),
      ]),
  ...
  route('api', 'routes/api/base-api.ts', [
    route('next-question', 'routes/api/next-question.ts'),
    route('generate-summary', 'routes/api/generate-summary.ts'),
  ]),
